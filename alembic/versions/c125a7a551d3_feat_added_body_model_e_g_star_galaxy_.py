...
Revision ID: c125a7a551d3
Revises: 
Create Date: 2023-02-10 17:40:07.150141
...
def upgrade():
    ...
    sa.Column('hd', sa.String(length=12), nullable=True, comment='Henry Draper (HD) Catalogue Number'),
    sa.Column('hr', sa.String(length=12), nullable=True, comment='Harvard Revised (HR) Catalogue Number'),
    sa.Column('hip', sa.String(length=12), nullable=True, comment='Hipparcos (HIP) Catalogue Number'),
    sa.Column('bd', sa.String(length=12), nullable=True, comment='Hipparcos (HIP) Catalogue Number'),
